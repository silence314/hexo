---
title: TCP/IP总结
date: 2020-09-11 16:31:16
tags: 
 - 计算机网络 
 - TCP/IP
description: TCP/IP相关总结
cover: /blogImg/计算机网络体系结构.png
categories: 计算机网络
...
想想自己还是网络工程专业的，当初计算机网络的课程老师讲的也十分仔细认真，可以说是大学最认真的老师之一了，甚至有了高中老师的感觉，当时也确实学的很明白，不过实际能接触，利用到相关知识的机会却几乎没有，但其实很多时候又能遇到，像现在的公司，涉及到全球多个国家之间的数据交互，毕竟是做真实外教的，所以希望也能真从中实战接触到这些网络知识。总结一下大学课本知识以后多看看。
...
![计算机网络体系结构](/blogImg/计算机网络体系结构.png)
